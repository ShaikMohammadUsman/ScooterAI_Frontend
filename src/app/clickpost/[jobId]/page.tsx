...
export default function PublicCandidatesPage() {
    ...
    const handlePageChange = (newPage: number) => {
        ...
        // Keep current selection during pagination to avoid UI fallback; it will update after data loads
    };
                                        ...
                                        {pagination && pagination.total_pages > 1 && (
                                            <div className="mt-6 flex items-center justify-between pt-4 border-t">
                                                <Button
                                                    ...
                                                    disabled={!pagination.has_previous || pageLoading}
                                                ...
                                                <span className="text-sm text-gray-600 flex items-center gap-2">
                                                    ...
                                                    {pageLoading && <Loader2 className="h-4 w-4 animate-spin text-gray-500" />}
                                                </span>
                                                <Button
                                                    variant="outline"
                                                    size="sm"
